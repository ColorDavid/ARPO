...
# kernel path: /localnvme/agent/tjy/ARPO/torchinductor_dongyinpeng/qy/cqy6tyzjvwbniqfuqgyg3mmbolcu2i2oounabq4s5wn2ht4q3bhs.py
...
triton_poi_fused_add_bitwise_and_bitwise_not_bitwise_or_ge_lt_mul_sub_0 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    size_hints=[131072], 
    filename=__file__,
    triton_meta={'signature': {0: '*i64', 1: '*i64', 2: '*i1', 3: 'i32', 4: 'i32', 5: 'i32', 6: 'i32', 7: 'i32', 8: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=80, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=108), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
...
@triton.jit
def triton_(in_ptr0, out_ptr0, out_ptr1, ks0, ks1, ks2, ks3, ks4, xnumel, XBLOCK : tl.constexpr):
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 128000
    arg1_1 = rand_strided((128000, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg2_1 = 0
    arg3_1 = 76032
    arg4_1 = 152064
    arg5_1 = 152064
